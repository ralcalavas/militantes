...
function guardarMilitante() {	
    var circunscripcion=document.getElementById("numero_identificacion").value.toString()+"-"+document.getElementById("combo_candidatura").value.toString()+"-"+document.getElementById("combo_departamento").value.toString()+"-"+document.getElementById("combo_municipio").value.toString()+"-"+document.getElementById("combo_localidad").value.toString();	
	$.ajax({
		type:"POST",
		data:"circunscripcion="+circunscripcion,
		url:"ajaxMilitante.php",
		success:function(a){			
			circunscripcion=a;
		}
	});	
