...
<html lang="en">
   ...
   <body>
         ...
         <?php
			...
			if(isset($_POST["guardar"])){
				...
				if($val==0){
					...
					echo "<script> alert('Se almacenaron los datos correctamente'); window.location.href='militante.php?id=".$id."&us=".$idUsu."'</script>";												
				}	
				else{
	    ...
	    <section id="content" class="seipkon-content-wrapper">
            <div class="page-content">
               <div class="container-fluid">   
			     <form id="militante" class="step-wizard" method="post" action="militante.php?id=<?=$id?>&us=<?=$idUsu?>">
	  ...
	  <script src="js/validar_militante.js"></script>	
	  <script>
		$(".fecha").datepicker({
			format:  'yyyy-mm-dd',
			language: "es",
